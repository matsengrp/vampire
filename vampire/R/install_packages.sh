...
for PACKAGE in alakazam ape argparse cowplot CollessLike data.table devtools dplyr entropy HDMD jsonlite latex2exp magrittr pegas Peptides pROC RecordLinkage shazam seqinr stringdist stringr svglite testthat textmineR yaml
do
