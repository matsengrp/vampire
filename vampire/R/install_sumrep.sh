...
for PACKAGE in alakazam ape argparse CollessLike data.table devtools dplyr entropy HDMD jsonlite magrittr pegas Peptides RecordLinkage shazam seqinr stringdist stringr testthat textmineR yaml
do
