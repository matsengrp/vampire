...
def build(params):
    ...
    merged_embedding = keras.layers.concatenate(
        [cdr3_embedding_flat, v_gene_embedding, j_gene_embedding],
    ...
    decoder = Model(
        z_mean_input,
        [decoder_cdr3_output, decoder_v_gene_output, decoder_j_gene_output],
    )
    vae = Model(
        [cdr3_input, v_gene_input, j_gene_input],
        [cdr3_output, v_gene_output, j_gene_output],
    )
    vae.compile(
        optimizer="adam",
        loss={
