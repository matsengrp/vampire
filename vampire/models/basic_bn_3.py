...
def build(params):
    ...
    encoder_dense_3 = BN(name='bn_encoder_3')(Dense(params['dense_nodes'], activation='elu',
                                                    name='encoder_dense_3')(encoder_dense_2))

    # Latent layers:
    z_mean = Dense(params['latent_dim'], name='z_mean')(encoder_dense_3)
    z_log_var = Dense(params['latent_dim'], name='z_log_var')(encoder_dense_3)
    ...
    decoder_dense_3_l = Dense(params['dense_nodes'], activation='elu', name='decoder_dense_3')
    bn_decoder_3_l = BN(name='bn_decoder_3')
    ...
    post_decoder_dense = bn_decoder_3_l(
        decoder_dense_3_l(
            bn_decoder_2_l(decoder_dense_2_l(bn_decoder_1_l(decoder_dense_1_l(z_l([z_mean, z_log_var])))))))
    ...
    decoder_post_decoder_dense = bn_decoder_3_l(
        decoder_dense_3_l(bn_decoder_2_l(decoder_dense_2_l(bn_decoder_1_l(decoder_dense_1_l(z_mean_input))))))
